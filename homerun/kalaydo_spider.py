...
def _get_house(url):
    ...
    data["rent"] = _get_number_attribute(soup, "Kaltmiete")
...
def get_houses(min_rooms, max_rent):
    url_template = "%s/immobilien/haus-mieten/o/rheinisch-bergischer-kreis/bergisch-gladbach/?ROOMS_FROM=%d&PRICE_TO=%d"
